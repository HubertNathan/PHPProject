...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.pastes' => 'getSmartUniqueNamer_PastesService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AgencyController', 'App\\Controller\\HangarController', 'App\\Controller\\MemberController', 'App\\Controller\\StarshipController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.pastes' => ['privates', 'vich_uploader.listener.clean.pastes', 'getVichUploader_Listener_Clean_PastesService', true],
            'vich_uploader.listener.remove.pastes' => ['privates', 'vich_uploader.listener.remove.pastes', 'getVichUploader_Listener_Remove_PastesService', true],
            'vich_uploader.listener.upload.pastes' => ['privates', 'vich_uploader.listener.upload.pastes', 'getVichUploader_Listener_Upload_PastesService', true],
        ], [
            ...
            'vich_uploader.listener.clean.pastes' => '?',
            'vich_uploader.listener.remove.pastes' => '?',
            'vich_uploader.listener.upload.pastes' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.pastes'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.pastes'], [['postFlush'], 'vich_uploader.listener.remove.pastes'], [['prePersist'], 'vich_uploader.listener.upload.pastes'], [['preUpdate'], 'vich_uploader.listener.upload.pastes']]);
    }
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'pastes' => [
                    ...
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.pastes',
                        'options' => [
