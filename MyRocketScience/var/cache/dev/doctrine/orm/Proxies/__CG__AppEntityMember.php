...
class Member extends \App\Entity\Member implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'agency' => [parent::class, 'agency', null],
        "\0".parent::class."\0".'email' => [parent::class, 'email', null],
        "\0".parent::class."\0".'hangars' => [parent::class, 'hangars', null],
        ...
        'agency' => [parent::class, 'agency', null],
        'email' => [parent::class, 'email', null],
        'hangars' => [parent::class, 'hangars', null],
